	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Add User Type</b></h3>
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('user-type.store')}}" method="post" enctype="multipart/form-data">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="user_type" id="example-autocomplete1" placeholder="User Type...">
	                                @error('user_type')
