	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Update Expense Category</b></h3>
	            <div class="block-options">
	            	<a href="{{route('expense-category.list')}}" class="btn btn-sm btn-alt-primary">
			            <i class="fa fa-list mr-5"></i>Expense Categoryes List
			        </a>
	            </div>
	        </div>
	        <div class="block-content">
	            <div class="row items-push">
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('expense-category.update',$expense->id)}}" method="post" enctype="multipart/form-data">
	                    	@csrf
	                        <div class="form-group row">
	                            <label class="col-12" for="example-autocomplete1">Expense Category Name: <span class="text-danger">*</span></label>
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" value="{{$expense->expense_category_name}}" name="expense_category_name" id="example-autocomplete1" placeholder="Expense Category Name">
	                            </div>
	                        </div>
