	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Update Ammount</b></h3>
	        ...
	        <div class="block-content">
	            <div class="row items-push">
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('ammount.update',$ammount->id)}}" method="post" enctype="multipart/form-data">
	                    	@csrf
	                    	<div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <select class="form-control" id="example-select" name="collection_point_id" required="">
                                        ...
                                        <option value="{{$data->id}}" {{ $ammount->collection_point_id == $data->id ? 'selected' : ''}}>{{$data->collection_point_name}}</option>
                                        @endforeach
                                    </select>
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" value="{{$ammount->ammounts}}" name="ammounts" id="example-autocomplete1" placeholder="ex: DH-202212">
	                                @error('ammounts')
