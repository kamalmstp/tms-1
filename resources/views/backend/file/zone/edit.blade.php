	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Update Zone</b></h3>
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('zone.update',$zone->id)}}" method="post" enctype="multipart/form-data">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" value="{{$zone->zone_name}}" name="zone_name" id="example-autocomplete1" placeholder="Zone Name...">
	                                @error('zone_name')
