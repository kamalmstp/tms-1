	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Add Collection Point</b></h3>
	        ...
	        <div class="block-content">
	            <div class="row items-push">
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('collection-point.store')}}" method="post" enctype="multipart/form-data">
	                    	@csrf
	                        <div class="form-group row">
	                            <label class="col-12" for="example-autocomplete1">Collection Point Name: <span class="text-danger">*</span></label>
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="collection_point_name" id="example-autocomplete1" placeholder="Collection Point Name...">
