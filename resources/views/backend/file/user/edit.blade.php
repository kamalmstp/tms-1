	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>User Update</b></h3>
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('user.update',$user->id)}}" method="post" enctype="multipart/form-data">
	                    	...
	                    	<div class="form-group row">
	                            ...
	                            <div class="col-12">
	                                <select class="form-control" id="example-select" name="user_type_id" required="">
                                        ...
                                        <option value="{{$data->id}}" {{ $user->user_type_id == $data->id ? 'selected' : ''}}>{{$data->user_type}}</option>
                                        @endforeach
                                    </select>
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="user_name" id="example-autocomplete1" value="{{$user->user_name}}" placeholder="User Name..">
	                                @error('user_name')
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="phone" id="example-autocomplete1" value="{{$user->phone}}" placeholder="User Phone Number..">
	                                @error('phone')
			                            <span class="text-danger">{{ $message }}</span>
			                        @enderror
	                            </div>
	                        ...
	                        <input type='file' value="{{$user->image}}" name="image" onchange="readURL(this);" /><br><br>
	                        <img id="image" src="{{$user->image ? '/' . $user->image :  '/asset/backend_asset/assets/media/various/image-svgrepo-com.svg'}}" height="200" width="250" alt="your image" /><br>
