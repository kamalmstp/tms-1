	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Update Bus</b></h3>
	            <div class="block-options">
	            	<a href="{{route('bus.list')}}" class="btn btn-sm btn-alt-primary">
			            <i class="fa fa-list mr-5"></i>Buses List
			        </a>
	            </div>
	        </div>
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('bus.update',$bus->id)}}" method="post" enctype="multipart/form-data">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" value="{{$bus->bus_code}}" name="bus_code" id="example-autocomplete1" placeholder="ex: DH-202212">
	                                @error('bus_code')
