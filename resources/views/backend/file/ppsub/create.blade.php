	...
	<div class="col-xl-8 single-filed">
		<div class="block">
	        <div class="block-header block-header-default">
	            <h3 class="block-title"><b>Add Police Payment Sub Sector</b></h3>
	        ...
	        <div class="block-content">
	            <div class="row items-push">
	                ...
	                <div class="col-xl-12">
	                    <form action="{{route('ppsub.store')}}" method="post" enctype="multipart/form-data">
	                    	@csrf
	                    	<div class="form-group row">
	                            ...
	                            <div class="col-12">
	                                <select class="form-control" id="example-select" name="main_sector_id" required="">
                                        ...
                                        <option value="{{$mainsector->id}}">{{$mainsector->sector_name}}</option>
                                        @endforeach
                                    </select>
	                            </div>
	                        </div>
	                        <div class="form-group row">
	                            <label class="col-12" for="example-autocomplete1">Police Payment Sub Sector Name: <span class="text-danger">*</span></label>
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="sub_sector_name" id="example-autocomplete1" placeholder="Police Payment Sub Sector Name...">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-lg-12">
	                                <input type="text" class="js-autocomplete form-control" name="phone" id="example-autocomplete1" placeholder="Phone Number...">
	                                @error('phone')
			                            <span class="text-danger">{{ $message }}</span>
			                        @enderror
	                            </div>
